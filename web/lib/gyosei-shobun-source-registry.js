...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "岡山県", sector: "takken", id: "okayama_takken", name: "岡山県 宅建業者監督処分", url: "https://www.pref.okayama.jp/page/detail-70300.html", discoveryStatus: "candidate", notes: "ポータルページ。業務停止・免許取消はMLITネガティブ情報へ誘導。一覧性は弱い。", expectedCoverage: "mlit_primary" }),
...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "三重県", sector: "kensetsu", id: "mie_kensetsu", name: "三重県 建設業者監督処分", url: "https://www.pref.mie.lg.jp/TOPICS/m0034900142.htm", discoveryStatus: "candidate", sourceType: "press_release_only", notes: "個別処分の報道発表形式。一覧ページは未確認。MLITで補完。", expectedCoverage: "mlit_primary" }),
