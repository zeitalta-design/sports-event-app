...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "石川県", sector: "takken", id: "ishikawa_takken", name: "石川県 宅建業者行政処分（基準）", url: "https://www.pref.ishikawa.lg.jp/kenju/shobunkizyun.html", discoveryStatus: "candidate", notes: "処分基準PDFのみ。処分一覧なし。confirmed不可。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "大分県", sector: "takken", id: "oita_takken", name: "大分県 宅建業者監督処分（基準）", url: "https://www.pref.oita.jp/soshiki/18500/kantokusyobun.html", discoveryStatus: "candidate", notes: "処分基準ページ。一覧はMLIT誘導。5年以内公表の案内あり。confirmed不可。", expectedCoverage: "mlit_primary" }),
