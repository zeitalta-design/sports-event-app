...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "愛媛県", sector: "kensetsu", id: "ehime_kensetsu", name: "愛媛県 建設業者監督処分", url: "https://www.pref.ehime.jp/page/5832.html", discoveryStatus: "candidate", notes: "重点再調査済み。ハブページ（各種お知らせ）にR7.9～R8.1の個別処分3件リンク確認。包括的な処分一覧ではなく直近数件のみ表示。個別公表が複数年あり継続的だが一覧性不足のため再確認候補継続。", expectedCoverage: "hybrid" }),
  ...
  prefSource({ pref: "長崎県", sector: "kensetsu", id: "nagasaki_kensetsu", name: "長崎県 建設業者監督処分", url: null, discoveryStatus: "candidate", sourceType: "press_release_only", notes: "第10バッチ再確認でcandidate昇格。個別press release（R7.9営業停止等）を確認。一覧ページはなく個別公表のみのためconfirmed不可。宅建はconfirmed。", expectedCoverage: "hybrid" }),
