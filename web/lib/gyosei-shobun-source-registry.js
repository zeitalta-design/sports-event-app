...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "岩手県", sector: "takken", id: "iwate_takken", name: "岩手県 宅建業者監督処分情報", url: "https://www.pref.iwate.jp/kurashikankyou/kenchiku/tetsuzuki/takuchi/1010436.html", discoveryStatus: "candidate", notes: "再確認候補。公表ページあり（H22以降、5年間掲載制度）。現時点で事例が空だが、処分発生時に掲載される継続導線。", expectedCoverage: "hybrid" }),
  ...
  prefSource({ pref: "石川県", sector: "takken", id: "ishikawa_takken", name: "石川県 宅建業者行政処分（基準）", url: "https://www.pref.ishikawa.lg.jp/kenju/shobunkizyun.html", discoveryStatus: "candidate", notes: "固定候補。処分基準PDFのみ。県独自の継続的公表ページなし。MLIT補完前提。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "島根県", sector: "takken", id: "shimane_takken", name: "島根県 宅建業者監督処分（基準）", url: "https://www.pref.shimane.lg.jp/infra/build/info/estate/gyosha_shobun.html", discoveryStatus: "candidate", notes: "再確認候補。公表方針あり（業者名・処分内容等をHP掲載と明記）。現時点で事例なし。処分発生時に確認すべき。", expectedCoverage: "hybrid" }),
  prefSource({ pref: "岡山県", sector: "takken", id: "okayama_takken", name: "岡山県 宅建業者監督処分（案内）", url: "https://www.pref.okayama.jp/page/detail-70300.html", discoveryStatus: "candidate", notes: "固定候補。県独自Web一覧なし。MLIT検索サイト+県庁窓口閲覧のみ。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "山口県", sector: "takken", id: "yamaguchi_takken", name: "山口県 宅建業者監督処分（基準）", url: "https://www.pref.yamaguchi.lg.jp/soshiki/135/24299.html", discoveryStatus: "candidate", notes: "固定候補。処分基準PDFのみ。処分事例なし。MLIT誘導。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "長崎県", sector: "takken", id: "nagasaki_takken", name: "長崎県 宅建業者監督処分", url: null, discoveryStatus: "candidate", notes: "再確認候補。公表制度あり（H22以降/5年間）だが現URL404。サイト改修後にURL再探索の余地あり。", expectedCoverage: "hybrid" }),
  prefSource({ pref: "熊本県", sector: "takken", id: "kumamoto_takken", name: "熊本県 宅建業者監督処分（基準）", url: "https://www.pref.kumamoto.jp/soshiki/115/4319.html", discoveryStatus: "candidate", notes: "固定候補。処分基準のみ。処分事例なし。MLIT誘導。", expectedCoverage: "mlit_primary" }),
  prefSource({ pref: "大分県", sector: "takken", id: "oita_takken", name: "大分県 宅建業者監督処分（基準）", url: "https://www.pref.oita.jp/soshiki/18500/kantokusyobun.html", discoveryStatus: "candidate", notes: "固定候補。処分基準PDFのみ。MLIT誘導中心。県独自Web一覧なし。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "鹿児島県", sector: "takken", id: "kagoshima_takken", name: "鹿児島県 宅建業者監督処分（案内）", url: "http://www.pref.kagoshima.jp/ah12/infra/kentiku/shidou/torihiki/sonota/takkengyoushashobunjouhou.html", discoveryStatus: "candidate", notes: "固定候補。案内ページのみ。MLIT検索サイト誘導。県独自Web一覧なし。", expectedCoverage: "mlit_primary" }),
  prefSource({ pref: "沖縄県", sector: "takken", id: "okinawa_takken", name: "沖縄県 宅建業者監督処分（基準）", url: "https://www.pref.okinawa.jp/site/doboku/shido/gyomu/kanntokushobunnkijyunn.html", discoveryStatus: "candidate", notes: "固定候補。処分基準PDFのみ。処分事例なし。MLIT誘導。", expectedCoverage: "mlit_primary" }),
];
...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "秋田県", sector: "kensetsu", id: "akita_kensetsu", name: "秋田県 建設業者監督処分（案内）", url: "https://www.pref.akita.lg.jp/pages/archive/4386", discoveryStatus: "candidate", notes: "固定候補。案内ページ。県庁閲覧所（5年分）+MLIT誘導。Web一覧なし。", expectedCoverage: "mlit_primary" }),
  prefSource({ pref: "山形県", sector: "kensetsu", id: "yamagata_kensetsu", name: "山形県 建設業者監督処分", url: null, discoveryStatus: "candidate", sourceType: "press_release_only", notes: "再確認候補。個別press release形式（R3-R6複数件）。一覧ページなし。URLは不安定だが処分公表の実績あり。", expectedCoverage: "hybrid" }),
  ...
  prefSource({ pref: "栃木県", sector: "kensetsu", id: "tochigi_kensetsu", name: "栃木県 建設業者監督処分（基準）", url: "https://www.pref.tochigi.lg.jp/h01/work/kensetsugyou/kyoka/kensetugyou_syobun.html", discoveryStatus: "candidate", notes: "固定候補。処分基準ページのみ。処分簿・一覧はWeb未掲載。MLIT誘導。", expectedCoverage: "mlit_primary" }),
  prefSource({ pref: "群馬県", sector: "kensetsu", id: "gunma_kensetsu", name: "群馬県 建設業者監督処分（基準）", url: "https://www.pref.gunma.jp/page/10901.html", discoveryStatus: "candidate", notes: "固定候補。処分基準ページのみ。処分一覧・処分簿はWeb未掲載。MLIT誘導。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "山口県", sector: "kensetsu", id: "yamaguchi_kensetsu", name: "山口県 建設業者監督処分（基準）", url: "https://www.pref.yamaguchi.lg.jp/site/kensetsugyo/23463.html", discoveryStatus: "candidate", notes: "固定候補。処分基準PDF（R7改正）のみ。MLIT誘導。県独自一覧なし。", expectedCoverage: "mlit_primary" }),
  prefSource({ pref: "徳島県", sector: "kensetsu", id: "tokushima_kensetsu", name: "徳島県 建設業者監督処分", url: "https://www.pref.tokushima.lg.jp/jigyoshanokata/kendozukuri/kensetsu/7303004/", discoveryStatus: "candidate", notes: "再確認候補。処分公表あり（R7年3月、Excel添付）。個別公表形式。継続的な一覧ページに育つ可能性あり。", expectedCoverage: "hybrid" }),
  ...
  prefSource({ pref: "愛媛県", sector: "kensetsu", id: "ehime_kensetsu", name: "愛媛県 建設業者監督処分", url: "https://www.pref.ehime.jp/page/129828.html", discoveryStatus: "candidate", notes: "再確認候補。個別処分公表あり（R6年12月事案）。一覧ページではないが、処分発生時に追加公表される可能性。", expectedCoverage: "hybrid" }),
