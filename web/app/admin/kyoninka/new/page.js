...
const FIELDS = [
  { key: "slug", label: "Slug", required: true, placeholder: "例: tokyo-abc-construction" },
  ...
  { key: "address", label: "住所", placeholder: "例: 千代田区丸の内1-1-1" },
  ...
  { key: "source_name", label: "情報元名", placeholder: "例: 国土交通省" },
...
export default function KyoninkaNewPage() {
  return (
    <AdminFormPage
      title="許認可事業者 新規作成"
      ...
      fields={FIELDS}
      defaults={{ is_published: 1, entity_status: "active", primary_license_family: "other", registration_count: 0 }}
    />
  );
}
