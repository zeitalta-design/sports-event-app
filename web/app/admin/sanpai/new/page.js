...
const FIELDS = [
  { key: "slug", label: "Slug", required: true, placeholder: "例: tokyo-xxx-sanpai" },
  { key: "company_name", label: "事業者名", required: true },
  { key: "corporate_number", label: "法人番号", placeholder: "例: 1234567890123" },
  { key: "prefecture", label: "都道府県", type: "select", options: [{ value: "", label: "選択" }, ...PREFECTURES.map((p) => ({ value: p, label: p }))] },
  { key: "city", label: "市区町村", placeholder: "例: 千代田区" },
  ...
  { key: "business_area", label: "事業区域", placeholder: "例: 関東地方一円" },
...
export default function SanpaiNewPage() {
  return (
    <AdminFormPage
      ...
      fields={FIELDS}
      defaults={{ is_published: 1, license_type: "other", waste_category: "industrial", status: "active", risk_level: "none", penalty_count: 0 }}
    />
  );
}
