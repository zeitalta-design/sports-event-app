        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/marathon" className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 sm:p-8 flex items-center gap-4 hover:shadow-md transition-shadow group">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold group-hover:text-blue-700 transition-colors" style={{ color: "#323433" }}>マラソン大会を探す</h2>
              <p className="text-xs font-medium mt-0.5" style={{ color: "#323433" }}>日程・エリア・距離で絞り込み</p>
            </div>
          ...
          <Link href="/trail" className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 sm:p-8 flex items-center gap-4 hover:shadow-md transition-shadow group">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base font-bold group-hover:text-green-700 transition-colors" style={{ color: "#323433" }}>トレイルラン大会を探す</h2>
              <p className="text-xs font-medium mt-0.5" style={{ color: "#323433" }}>山岳レース・自然系ランイベント</p>
            </div>
