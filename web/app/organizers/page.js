 ...
 *
 * /organizers — 大会運営者にスポ活の掲載メリットと価値を伝える
...
const BENEFITS = [
  {
    title: "全国のランナーに届く",
    description:
      "スポ活には全国のランナーが大会を探しに訪れます。掲載情報が充実するほど、検索結果や関連大会として表示される機会が増えます。",
  },
  {
    title: "大会の反響が見える",
    description:
  ...
  },
  {
    title: "情報の正確性が信頼を生む",
    description:
      "正確な開催情報は、ランナーの安心感と信頼につながります。スポ活では情報の鮮度と正確性を重視し、運営者の方からの更新を歓迎しています。",
  },
  {
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-sm text-gray-600 leading-relaxed max-w-2xl">
          スポ活は、全国のマラソン・トレイルランニング大会の情報を集約し、
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-50 rounded-xl p-6 space-y-4">
          <p className="text-sm text-gray-600 leading-relaxed">
            スポ活では、複数の情報ソースを定期的に照合し、掲載データの正確性を維持しています。
          </p>
      ...
      <section className="mb-12">
        ...
        <p className="text-sm text-gray-500 mb-4">
          スポ活では、以下のような形でランナーに大会情報を届けています。
        </p>
